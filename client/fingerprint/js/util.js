		...
		*/
		...
		if (__My_buffer_flag == 4){
			...
			for (var i =0; i < __ActiveBuffer_vertex_normal.length; i += 3){
				...
				t_nor = t_nor.concat(-1 *  (__ActiveBuffer_vertex_normal[i] * __Mworld_fs[2] + __ActiveBuffer_vertex_normal[i+1] * __Mworld_fs[6] + __ActiveBuffer_vertex_normal[i+2] * __Mworld_fs[10])) ;
			}
