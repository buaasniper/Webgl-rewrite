  ...
  for (int i = 0 ; i < 510; i += 3){
      ...
      if (judge(x0, y0, x1, y1, x2, y2, x3, y3) > 0.9) {
        ...
        if ((K <= 2.0) && (K >= -2.0) && (K > z)){
          ...
          gl_FragColor = vec4( w( w (   w (w(x0) * w(y2)) + w (w(x2) * w(y3)) + w (w(x3) * w(y2)) - w (   w (w(x3) * w(y2)) + w (w(x2) * w(y0)) + w (w(x0) * w(y3)) ) ) /  w ( w (w(x0) * w(y2)) + w (w(x2) * w(y3)) + w (w(x3) * w(y2)) - w (   w (w(x3) * w(y2)) + w (w(x2) * w(y0)) + w (w(x0) * w(y3)) )  - 100.0 ) * 255.0) / 255.0 ,
           0.0    , 0.0 , 1.0);
