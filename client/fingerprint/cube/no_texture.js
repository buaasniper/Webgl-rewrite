   ...
   'for (int i = 0 ; i < 36; i += 3){'+
      ...
      'if (judge(x0, y0, x1, y1, x2, y2, x3, y3) > 0.9) {'+
          ...
          'if ((C > 0.0) && (K <= 2.0) && (K >= -2.0) && (K > z)){'+
              'z = K;'+
              'r = floor ((wei_1 * r1 + wei_2 * r2 + wei_3 * r3)/1000.0 * 255.0 + 0.1) / 255.0  ; '+
              'g = floor ((wei_1 * g1 + wei_2 * g2 + wei_3 * g3)/1000.0 * 255.0 + 0.1) / 255.0 ; '+
              'b = floor ((wei_1 * b1 + wei_2 * b2 + wei_3 * b3)/1000.0 * 255.0 + 0.1) / 255.0 ; '+
