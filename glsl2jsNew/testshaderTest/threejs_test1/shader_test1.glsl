...
vec3 linePlaneIntersect( in vec3 pointOnLine, in vec3 lineDirection, in vec3 pointOnPlane, in vec3 planeNormal ) {
	...
	#endif
	#if 6 > 0
		uniform mat4 pointShadowMatrix[ 6 ];
		varying vec4 vPointShadowCoord[ 6 ];
	#endif
#endif
...
#define Material_LightProbeLOD( material )	(0)
	...
	#endif
	#if 6 > 0
		uniform sampler2D pointShadowMap[ 6 ];
		varying vec4 vPointShadowCoord[ 6 ];
	#endif
...
IncidentLight directLight;
	...
	PointLight pointLight;
		...
		getPointDirectLightIrradiance( pointLight, geometry, directLight );
		#ifdef USE_SHADOWMAP
		directLight.color *= all( bvec2( pointLight.shadow, directLight.visible ) ) ? getPointShadow( pointShadowMap[ 1 ], pointLight.shadowMapSize, pointLight.shadowBias, pointLight.shadowRadius, vPointShadowCoord[ 1 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometry, material, reflectedLight );
		...
		getPointDirectLightIrradiance( pointLight, geometry, directLight );
		#ifdef USE_SHADOWMAP
		directLight.color *= all( bvec2( pointLight.shadow, directLight.visible ) ) ? getPointShadow( pointShadowMap[ 2 ], pointLight.shadowMapSize, pointLight.shadowBias, pointLight.shadowRadius, vPointShadowCoord[ 2 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometry, material, reflectedLight );
		...
		getPointDirectLightIrradiance( pointLight, geometry, directLight );
		#ifdef USE_SHADOWMAP
		directLight.color *= all( bvec2( pointLight.shadow, directLight.visible ) ) ? getPointShadow( pointShadowMap[ 3 ], pointLight.shadowMapSize, pointLight.shadowBias, pointLight.shadowRadius, vPointShadowCoord[ 3 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometry, material, reflectedLight );
		...
		getPointDirectLightIrradiance( pointLight, geometry, directLight );
		#ifdef USE_SHADOWMAP
		directLight.color *= all( bvec2( pointLight.shadow, directLight.visible ) ) ? getPointShadow( pointShadowMap[ 4 ], pointLight.shadowMapSize, pointLight.shadowBias, pointLight.shadowRadius, vPointShadowCoord[ 4 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometry, material, reflectedLight );
		...
		getPointDirectLightIrradiance( pointLight, geometry, directLight );
		#ifdef USE_SHADOWMAP
		directLight.color *= all( bvec2( pointLight.shadow, directLight.visible ) ) ? getPointShadow( pointShadowMap[ 5 ], pointLight.shadowMapSize, pointLight.shadowBias, pointLight.shadowRadius, vPointShadowCoord[ 5 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometry, material, reflectedLight );
