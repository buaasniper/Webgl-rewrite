          ...
          testDone = (function(_this) {
            return function() {
              ...
              if (_this.numTestsComplete < _this.testList.length) {
                // var wasmInstance = new MatrixCalculator('./webassembly/matrix.wasm', beginDraw); 
                //function beginDraw(wasmInstance) {
                  return _this.testList[_this.numTestsComplete].begin(_this.canvas, testDone);
                //}
              }
            };
          })(this);
          // wasmInstance = new MatrixCalculator('./webassembly/matrix.wasm', beginDraw); 
...
var matrixCalculator = new  MatrixCalculator('./webassembly/matrix.wasm', startfunc); 
